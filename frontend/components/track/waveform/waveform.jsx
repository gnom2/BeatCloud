...
//   render() {
//     const { trackPlayer, track } = this.props;
//     let timeElapsedBar;
//     let elapsedTime;
//     let durationTime;
//     let scrollbarMax;
...
//     if (this.wavesurfer) {
//       if (track.id === trackPlayer.track_id) {
//         this.scrollbar.current.value = 0;
//         elapsedTime = formatTrackTime(trackPlayer.timeElapsed);
//       } else {
//         elapsedTime = "0:00";
//       }
...
//       trackPlayer.playing &&
//       this.wavesurfer &&
//       track.id === trackPlayer.track_id
//     ) {
//       let waveformSeekVal =
//         (trackPlayer.timeElapsed + 0.5) / this.wavesurfer.getDuration();
...
//       this.scrollbar.current.value = trackPlayer.timeElapsed || "0";

//       timeElapsedBar = (
//         <p id="time-elapsed-bar">{formatTrackTime(trackPlayer.timeElapsed)}</p>
//       );
//     }
...
//         <div id={`waveform-${track.id}`} ref={this.waveformRef}></div>
